...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'ShadowsIntoLightTwo-Regular',
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#E8CF78',
  brandInfo: '#058ED9',
  brandSuccess: '#9DAF85',
  brandDanger: '#F03A47',
  brandWarning: '#FB8B24',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'ShadowsIntoLightTwo-Regular',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#9DAF85' : '#7C4A33',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#737373' : '#DBCDC6',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  sTabBarActiveTextColor: '#007aff',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#7C4A33',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#DBCDC6',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#DBCDC6',
  get statusBarColor() {
  ...
  listDividerBg: '#E8CF78',
  listBtnUnderlayColor: '#DDD',
  listItemPadding: platform === PLATFORM.IOS ? 10 : 12,
  listNoteColor: '#808080',
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#9DAF85',
  ...
  radioSelectedColorAndroid: '#9DAF85',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#9DAF85',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#9DAF85',
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#9DAF85',
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#9DAF85',
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : 'ShadowsIntoLightTwo-Regular',
